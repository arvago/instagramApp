...
import 'package:flutter_formulario/views/feed.dart';
...
import 'package:flutter_formulario/widgets/searchs_widget.dart';
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) => Feed(userLoggedd: userLogged)
                    ));
                    return;
                  }
                )
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFieldWidget(
                ...
                hintText: 'Search',
                onPrefixIconTap: () => {
                  lista = profileService.obtenerSearch(_controllerSEARCH.text)
                },
              ),
            ),
            Expanded(
                ...
                builder:(BuildContext context, AsyncSnapshot snapshot){
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index){
                      return SearchWidget(name: snapshot.data[index].name, userName: snapshot.data[index].userName, urlImage: snapshot.data[index].urlProfile);
                    }
                  );
                }    
              )             
